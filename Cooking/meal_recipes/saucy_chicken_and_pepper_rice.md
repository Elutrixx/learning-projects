...
hardware_required:
  ...
  - tools: [medium_skillet, chef_knife, cutting_board, spatula]
tags:
  - basics
  - chicken
  - bell_pepper
...
# Recipe: Saucy Chicken & Bell Pepper Rice Bowl

## Equipment Needed
- 1 medium skillet or pan
- Pot with tight-fitting lid (for rice)
...
### Step 3: Pan-fry & Combine (~15 mins)
1. **Heat Pan (2 mins):** Add 1 tbsp oil to your skillet. Turn heat to **Dial 4** (medium-high). Let the pan get hot for 2 minutes.
...
- **Why lower the heat before adding sauce?** Store-bought sauces contain sugar which burns easily on high heat. Lowering the heat to Dial 2 keeps it at a gentle bubble without burning.
